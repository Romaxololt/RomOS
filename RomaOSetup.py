version = "alpha 0.1"
import os
listescr = "core.py","Ctone.py","ErreurLST.txt","GT8+.py","Log.txt","Logo.ico","ROS.py","Thor.py","Wath_ER.py","Rogit.py","CryptROS.py"
print("\n")
...
set "libraries=matplotlib numpy pandas"
...
init()
print(Fore.BLUE + "installation terminée lancer ROS.py !")
import time 
time.sleep(1)
